...
The plot in base R can be generated including the argument `make_gg = FALSE` in the call to `plot()`.
...
iso_fit <- fit_isothermal_inactivation(model_name, isothermal_inactivation,  
                                       starting_point, known_params, adjust_log)
```
